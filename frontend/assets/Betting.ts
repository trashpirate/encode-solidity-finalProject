export const bettingABI = [
  ...
  },
  {
    ...
    name: "book",
    outputs: [
      { internalType: "enum Betting.Position", name: "position", type: "uint8" },
  ...
  {
    inputs: [{ internalType: "uint256", name: "endPrice", type: "uint256" }],
    name: "closeRound",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  ...
  },
  {
    inputs: [],
    name: "paymentToken",
    outputs: [{ internalType: "contract MyERC20Token", name: "", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
  {
  ...
  },
  {
    inputs: [],
    name: "winner",
    outputs: [{ internalType: "enum Betting.Position", name: "", type: "uint8" }],
    stateMutability: "view",
    type: "function",
  },
] as const;
